...
| [domain/colour-gap-states.md](domain/colour-gap-states.md) | ครึ่งหลังของการ์ดบน (แตกที่ใบ 043): ตอบสีแล้วคาบเก่ายังไม่ขยับ เพราะกฎสีมีผลตอน sync เท่านั้น · สองสถานะ unruled/unapplied · `pending` ทำไมไม่ใช่ยอดดิบ · สามหน้าจอคนละสโคป · คาบที่ตรวจมือแล้วยังไม่มีหน้าจอไหนแก้ได้ (ใบ 070) |
