...
| Agent | Model | Why |
|---|---|---|
| `architect` · `backend-dev` · `security-reviewer` · `code-reviewer` · `payroll-auditor` | **opus** | schema decisions · money and domain invariants · auth · the review that is the last thing between a defect and `develop` |
